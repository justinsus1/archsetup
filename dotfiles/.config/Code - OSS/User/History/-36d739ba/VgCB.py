...
with sync_playwright() as p:
    try:
        ...
        page.goto("https://play.ttrockstars.com/gamel/play/garage", timeout=100000000)
        
        # Wait for the page to fully load by waiting for the main page element (e.g. body or any key selector)
        page.wait_for_selector("body", timeout=10000000)  # Ensure the body of the page loads

        # Wait for specific elements (for example, elements that indicate page readiness)
        page.wait_for_selector('span', timeout=10000000)  # Wait for any span element to load
